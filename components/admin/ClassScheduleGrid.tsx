          ...
          <table className="w-full text-xs text-left border-collapse select-none">
            ...
            <tbody className="divide-y divide-zinc-800/80">
              {TIME_SLOTS.map((slot, slotIdx) => (
                <tr key={slot} className="h-14 hover:bg-zinc-800/30 transition-colors">
                  ...
                  {DAYS.map((d) => {
                    ...
                    return (
                      <td
                        ...
                        className={`p-1 border-r border-zinc-800/80 transition-all relative h-full ${
                          isDragOver
                          ...
                          >
                            <div className="space-y-1">
                              ...
                              <div className="flex items-center justify-between gap-1 text-[10px] text-zinc-400 pointer-events-none">
                                ...
                                {timeRangeText ? (
                                  <span className="font-mono text-[9px] font-bold px-1.5 py-0.5 rounded bg-zinc-950/40 text-zinc-300">
                                    {timeRangeText}
                                  </span>
                                ) : (
