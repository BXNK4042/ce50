...
export default function Footer({ lang }: { lang: string }) {
  ...
  return (
    <footer className="bg-white dark:bg-black text-zinc-600 dark:text-zinc-400 border-t border-zinc-200 dark:border-zinc-900 pt-16 pb-8 transition-colors duration-300">
