...
export default async function HomePage({
  ...
  return (
    <>
      ...
      <div className="relative h-screen w-full bg-blue-800 dark:bg-[#0a192f] p-12 md:p-16 flex flex-col gap-6 transition-colors duration-300">
