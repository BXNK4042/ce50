      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 w-full max-w-none">
        {teachers.map((teacher) => {
          ...
          return (
            <div
              key={teacher.id}
              className={`w-full h-[300px] border border-zinc-200 dark:border-zinc-800 overflow-hidden transition-all duration-300 hover:shadow-lg cursor-pointer select-none flex flex-col justify-end relative group bg-gradient-to-b from-[#a7c7f2] to-[#2b5c9e] dark:from-[#3b7cd4] dark:to-[#12294a] ${
                isAthasart
